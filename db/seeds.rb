...
product_1 = Product.create(colour:'white', size:'S', price:20.99, stock_level:50)
product_2 = Product.create(colour:'white', size:'M', price:22.99, stock_level:50)
product_3 = Product.create(colour:'white', size:'L', price:20.99, stock_level:50)
product_4 = Product.create(colour:'blue', size:'S', price:20.99, stock_level:50)
product_5 = Product.create(colour:'blue', size:'M', price:22.99, stock_level:50)
product_6 = Product.create(colour:'blue', size:'L', price:20.99, stock_level:50)
product_7 = Product.create(colour:'red', size:'S', price:20.99, stock_level:50)
product_8 = Product.create(colour:'red', size:'M', price:22.99, stock_level:50)
product_9 = Product.create(colour:'red', size:'L', price:20.99, stock_level:50)
product_10 = Product.create(colour:'yellow', size:'S', price:20.99, stock_level:50)
...
lineItem_1 = LineItem.create(product_id:product_1.id, design_id:design_1.id, qty:3, order_id:order_1.id)
lineItem_2 = LineItem.create(product_id:product_2.id, design_id:design_2.id, qty:1, order_id:order_2.id)
lineItem_3 = LineItem.create(product_id:product_3.id, design_id:design_3.id, qty:3, order_id:order_3.id)
lineItem_4 = LineItem.create(product_id:product_4.id, design_id:design_4.id, qty:3, order_id:order_4.id)
lineItem_5 = LineItem.create(product_id:product_5.id, design_id:design_5.id, qty:1, order_id:order_5.id)
