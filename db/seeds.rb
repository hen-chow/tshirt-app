...
product_1 = Product.create(colour:'white', size:'S', price:20.99, stock_level:50, img_src:'white.png', thumbnail:'white_thumbnail.jpg')
product_2 = Product.create(colour:'white', size:'M', price:22.99, stock_level:50, img_src:'white.png', thumbnail:'white_thumbnail.jpg')
product_3 = Product.create(colour:'white', size:'L', price:20.99, stock_level:50, img_src:'white.png', thumbnail:'white_thumbnail.jpg')
...
product_10 = Product.create(colour:'yellow', size:'S', price:20.99, stock_level:50, img_src:'yellow.png', thumbnail:'yellow_thumbnail.jpg')
product_11 = Product.create(colour:'yellow', size:'M', price:22.99, stock_level:50, img_src:'yellow.png', thumbnail:'yellow_thumbnail.jpg')
product_12 = Product.create(colour:'yellow', size:'L', price:20.99, stock_level:50, img_src:'yellow.png', thumbnail:'yellow_thumbnail.jpg')

design_1 = Design.create(name:'des1', length:'300', width:'300', img_src:'des1.png', predesign:'true', user_id:user_1.id)
